...
const countrySearch = document.querySelector("#countrylist");


countryList.forEach(item => {
    let data = `<option value="${item.code}">${item.name}</option>`
    countrySearch.insertAdjacentHTML("afterbegin",data)
})
